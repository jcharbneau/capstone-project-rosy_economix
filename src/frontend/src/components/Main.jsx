...
const rawData = [
  { "desc":"Stock data for 481 Tickers", "freq":"daily", "source": "Yahoo Finance", "records": "4,553,117 records" },
  { "desc":"Consumer Price Index (CPI)", "freq":"monthly",  "source": "Federal Reserve", "records": "929 records" },
  { "desc":"Gross Domestic Product (GDP)", "freq":"quarterly",  "source": "Federal Reserve", "records": "313 records" },
  { "desc":"Unemployment (UNRATE)", "freq":"monthly",  "source": " Federal Reserve", "records": "917 records" },
  { "desc":"Nonfarm Payrolls (PAYEMS)", "freq":"monthly", "source": "Federal Reserve", "records": "1025 records" },
  { "desc":"Job Openings (JTSJOL)", "freq":"monthly", "source": "Federal Reserve", "records": "281 records" },
  { "desc":"Average Hourly Earnings (AHETPI)", "freq":"monthly", "source": "Federal Reserve", "records": "725 records" },
  { "desc":"Total Wages and Salaries (BA06RC1A027NBEA)", "freq":"annually", "source": "Federal Reserve", "records": "41 records" },
  { "desc":"Employment Cost Index (ECIWAG)", "freq":"quarterly", "source": "Federal Reserve", "records": "177 records" },
  { "desc":"Average Weekly Earnings (CES0500000011)", "freq":"monthly", "source": "Federal Reserve", "records": "219 records" },
  {"desc":"Consumer Spending (PCEC)", "freq":"",  "source": "Federal Reserve", "records": "" },
  {"desc":"Labor Force Participation Rate (CIVPART)", "freq":"",  "source": "Federal Reserve", "records": "" },
  {"desc":"Discouraged Workers (LNU05026645)", "freq":"",  "source": "Federal Reserve", "records": "" },
  {"desc":"Marginally Attached Workers (LNU05026645)", "freq":"",  "source": "Federal Reserve", "records": "" },
  {"desc":"Underemployment Rate (U6RATE)", "freq":"",  "source": "Federal Reserve", "records": "" },
  {"desc":"Consumer Sentiment Index (UMCSENT)", "freq":"",  "source": "Federal Reserve", "records": "" }
];
...
const Main = () => (
  ...
  <div className="main-content-c1-flex main-content-c1-flex-col main-content-c1-p-6 main-content-c1-m-4 main-content-c1-overflow-y-scroll main-content-c1-max-h-full main-content-c1-bg-white main-content-c1-rounded-lg main-content-c1-shadow-md">
    ...
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">While this project has come a long way in six weeks, it has a long way to go. In many ways, it is a presentation of what is possible; and in no way should be considered "production worthy". You will see bugs, you will likely encounter data that is inaccurate, you will encounter broken functionality and potential layout issues. While I have longer term ideas, this is a project for a class; and so certain ideas had to be left for later. I also believe determining the "Rosiness" of various readings of economics is a goal that is nebulous, and so may take a few extra minutes ;-).</p>
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">Please keep this in mind as you navigate this demonstration.</p>
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">Eventually, I anticipate updating this tool to be more accessible to various browsers and mobile devices; but in this early proof-of-concept, I am only targeting Google Chrome.</p>

    <h2 className="main-content-c1-text-2xl main-content-c1-font-semibold main-content-c1-mb-2 main-content-c1-text-gray-800">Technology Stack</h2>
    <ul className="main-content-c1-list main-content-c1-mb-4 main-content-c1-text-gray-700">
      <li className="main-content-c1-mb-2 main-content-c1-flex main-content-c1-items-center"><i className="fab fa-react main-content-c1-mr-2 text-blue-600"></i>ReactJS</li>
      <li className="main-content-c1-mb-2 main-content-c1-flex main-content-c1-items-center"><i className="fas fa-rocket main-content-c1-mr-2 text-green-600"></i>FastAPI</li>
      <li className="main-content-c1-mb-2 main-content-c1-flex main-content-c1-items-center"><i className="fas fa-database main-content-c1-mr-2 text-indigo-600"></i>PostgreSQL</li>
      <li className="main-content-c1-mb-2 main-content-c1-flex main-content-c1-items-center"><i className="fas fa-tools main-content-c1-mr-2 text-red-600"></i>Data Build Tool (dbt-core)</li>
      <li className="main-content-c1-mb-2 main-content-c1-flex main-content-c1-items-center"><img src={astronomer_logo} alt="Astronomer.io" className="main-content-c1-mr-2" style={{ width: '1em', height: '1em' }} />Astronomer.io</li>
      <li className="main-content-c1-mb-2 main-content-c1-flex main-content-c1-items-center"><i className="fab fa-python main-content-c1-mr-2 text-blue-600"></i>Python 3</li>
      <li className="main-content-c1-mb-2 main-content-c1-flex main-content-c1-items-center">
    ...
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">
      ...
      by augmenting and overlaying them with various events.
    </p>
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">
    ...
    <h2 className="main-content-c1-text-2xl main-content-c1-font-semibold main-content-c1-mb-2 main-content-c1-text-gray-800">Notes on the data</h2>
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">The following table provides an overview of the data sources used in this project.</p>
    <div className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">
        ...
        <tbody>
          {rawData.map((item, index) => (
            <tr key={index} className="bg-white border-b border-gray-200 hover:bg-gray-50">
              ...
              <td className="py-2 px-4 whitespace-nowrap text-sm text-gray-500">{item.records}</td>
    ...
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">
      ...
      earlier query of "How can we know the whole story?".
    </p>
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">
    ...
    <ul className="main-content-c1-list main-content-c1-mb-4 main-content-c1-text-gray-700">
      <li className="main-content-c1-mb-2 main-content-c1-flex main-content-c1-items-center">Ronnie Hash, Jr. always there to lend a hand and provide thoughtful objective critique!</li>
    ...
    <p className="main-content-c1-text-base main-content-c1-leading-relaxed main-content-c1-mb-4 main-content-c1-text-gray-700">And of course one final round of thanks to Zach, Julie, Mitali and the rest of the DataExpert team! Had a blast with this boot camp!</p>
  </div>
</div>
